                ...
                <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" maxlength="50" required class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-agro-green focus:ring-1 focus:ring-agro-green transition" placeholder="Ej. Tomate Manta de Cielo">
                            @error('name')
                        ...
                        <div>
                            ...
                            <select name="producer_id" id="producer_id" required class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-agro-green focus:ring-1 focus:ring-agro-green transition">
                                <option value="" disabled {{ old('producer_id') ? '' : 'selected' }}>Selecciona un productor</option>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" name="price" id="price" value="{{ old('price') }}" required class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-agro-green focus:ring-1 focus:ring-agro-green transition" placeholder="0.00">
                            @error('price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
