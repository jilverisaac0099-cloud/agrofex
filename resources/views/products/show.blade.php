        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 p-8">
                ...
                <div class="mb-6 border-t border-gray-100 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Productor</h3>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {{ $product->producer->name ?? 'Sin productor' }}
                    </span>
                </div>

                <div class="mb-6 border-t border-gray-100 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Categoria</h3>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                ...
                <div class="mt-8 border-t border-gray-100 pt-6">
                    ...
                    <div class="text-gray-700 bg-gray-50 p-4 rounded-xl border border-gray-100 min-h-[150px] whitespace-pre-line">
                        {{ $product->price ?? 'Este producto no tiene precio registrado.'}}
                    </div>
                </div>
