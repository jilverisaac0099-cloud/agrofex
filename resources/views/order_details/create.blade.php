    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-bold text-2xl text-white leading-tight tracking-tight">
                {{ __('Registrar Detalle de Pedido') }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-agro-card shadow-xl sm:rounded-3xl border border-zinc-800 overflow-hidden relative">
                ...
                <form method="POST" action="{{ route('order_details.store') }}" class="p-8 space-y-6 relative z-10">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="amount" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="number" step="0.01" min="0.01" name="amount" value="{{ old('amount') }}" required />
                        ...
                        <div>
                            ...
                            <input id="price" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="number" step="0.01" min="0" name="price" value="{{ old('price') }}" required />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="subtotal" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="number" step="0.01" min="0" name="subtotal" value="{{ old('subtotal') }}" required />
                    ...
                    <div class="flex items-center justify-end gap-6 mt-10 pt-6 border-t border-zinc-800">
                        <a href="{{ route('order_details.index') }}" class="text-sm text-gray-400 hover:text-white transition font-medium">Cancelar y volver</a>
