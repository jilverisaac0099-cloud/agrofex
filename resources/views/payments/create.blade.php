                ...
                <form method="POST" action="{{ route('payments.store') }}" class="p-8 space-y-6 relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="payment_method" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="payment_method" placeholder="Ej. Efectivo, Transferencia..." value="{{ old('payment_method') }}" required />
                        ...
                        <div>
                            ...
                            <input id="amount_paid" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="number" step="0.01" min="0" name="amount_paid" value="{{ old('amount_paid') }}" required />
