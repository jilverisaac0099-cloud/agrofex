                ...
                <form method="POST" action="{{ route('producers.store') }}" class="p-8 space-y-6 relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input id="name" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="name" value="{{ old('name') }}" required autofocus />
                            @error('name') <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="lastname" class="block font-medium text-sm text-gray-300 mb-2">Apellido(s)</label>
                            <input id="lastname" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="lastname" value="{{ old('lastname') }}" required />
                        ...
                        <div>
                            ...
                            <input id="email" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="email" name="email" value="{{ old('email') }}" required />
                            @error('email') <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="telephone" class="block font-medium text-sm text-gray-300 mb-2">Teléfono</label>
                            <input id="telephone" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="telephone" value="{{ old('telephone') }}" required />
                        ...
                        <div>
                            ...
                            <input id="schedule" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="schedule" value="{{ old('schedule') }}" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="address" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors" type="text" name="address" value="{{ old('address') }}" required />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3" class="block w-full bg-agro-dark border-zinc-700 text-white focus:border-agro-green focus:ring-agro-green rounded-xl shadow-sm px-4 py-3 transition-colors">{{ old('description') }}</textarea>
