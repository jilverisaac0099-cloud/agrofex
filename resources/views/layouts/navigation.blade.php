...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <x-nav-link :href="route('order_details.index')" :active="request()->routeIs('order_details.')">
        {{ __('order details') }}
    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('customers.index')" :active="request()->routeIs('customers.*')">
              ...
              <x-responsive-nav-link :href="route('producers.index')" :active="request()->routeIs('producers.*')">
                {{ __('productores') }}
            </x-responsive-nav-link>


            <x-responsive-nav-link :href="route('categories.index')" :active="request()->routeIs('categoriesies.*')">
                {{ __('categorias') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('order_details.index')" :active="request()->routeIs('order_details.*')">
